...
public class Tester {
    ...
    public static void testPart3() {
        ...
        CardLock myLock = new CardLock();
        myDoor.attachLock(myLock);

        SmartCard studentCard = new SmartCard("Bryan");
        myLock.swipeCard(studentCard);
        myDoor.openDoor();

        SmartCard staffCard = new SmartCard("Mr. Vullo");
        staffCard.setStaff(true);
        myLock.swipeCard(staffCard);
        myDoor.openDoor();
    }
}

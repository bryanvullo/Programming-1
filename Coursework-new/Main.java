...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    String[] score2 = {"C4", "C4", "D4", "none", "C4", "none", "F4", "none", "E4", "none", "none", "none",
    ...
    myComposition.addScore("Violin", List.of(score2), true);
    myComposition.addScore("Cello", List.of(score2), true);
    myComposition.addScore("Piano", List.of(score2), true);
